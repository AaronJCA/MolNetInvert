...
class MainApp(tk.Frame):
    ...
    def preferenceFilter(self):
        ...
        for nodeID in allNodesDicCopy:
            ...
            #find out what the largest cluster is
    ...
    def writeNewFile(self):
        ...
        if str(fileSaveName) != "None":
            ...
            nodes.append('      <rdf:Description rdf:about="https://www.bioengineering.dtu.dk/research/research-infrastructures/dtu-metabolomics-core/">')
            nodes.append('        <dc:type>MolNetInvert</dc:type>')
            nodes.append('        <dc:description>N/A</dc:description>')
            nodes.append('        <dc:identifier>N/A</dc:identifier>')
            nodes.append('        <dc:date>2024-06-01 19:07:57</dc:date>')
            nodes.append('        <dc:title>Sheet1</dc:title>')
            nodes.append('        <dc:source>https://github.com/AaronJCA/MolNetInvert/</dc:source>')
            ...
            for edgeID in MainApp.edgesToWrite:
                ...
                normalisedEdgeWeight = (float(MainApp.edgesToWrite[edgeID].averageOfPeakAreas) - MainApp.minEdge) / (MainApp.maxEdge - MainApp.minEdge) * 3 + 0.1
                ...
                edges.append('    <att name="Normalised Area" value="' + str(normalisedEdgeWeight) + '" type="real" cy:type="Double"/>')
                edges.append('    <graphics fill="#ABABAB"  width="' + str(float(normalisedEdgeWeight)) + '">')
    ...
    def initialiseGUI(self):
        MainApp.versionName = 'MolNetInvert v1.2'
        root.title(MainApp.versionName)
